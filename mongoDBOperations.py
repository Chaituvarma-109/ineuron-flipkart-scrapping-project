...
class MongoDBManagement:
    ...
    def getDatabase(self, db_name):
        ...
        try:
            ...
            raise Exception(f"(getDatabase): Failed to get the database list"+str(e))
    ...
    def getCollection(self, collection_name, db_name):
        ...
        try:
            ...
            raise Exception(f"(getCollection): Failed to get the database list."+str(e))
    ...
    def findAllRecords(self, db_name, collection_name):
        ...
        try:
            ...
            raise Exception(f"(find_all_records): Failed to find record for the given collection and database\n"
                            + str(e))
    ...
    def findRecordOnQuery(self, db_name, collection_name, query):
        ...
        try:
            ...
            if collection_check_status:
                collection = self.getCollection(collection_name=collection_name, db_name=db_name)
                find_records = collection.find(query)
                return find_records
        except Exception as e:
            raise Exception(
